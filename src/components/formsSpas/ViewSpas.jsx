...
const ViewSpas = () => {
    const [spas, setCViewSpas] = useState([]);
    ...
    const getCViewSpas = async () => {
        try {
            const response = await axios.get('http://127.0.0.1:8000/api/spas', config);
            setCViewSpas(response.data);
    ...
    const handleDelete = async (id) => {
        try {
            const response = await axios.delete(`http://127.0.0.1:8000/api/spas/${id}/`);
