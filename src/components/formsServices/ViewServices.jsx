...
const ViewServices = () => {
    ...
    const columns = [
        ...
        { id: 'actions', label: 'Aciones', minWidth: 100 }
    ];
    ...
    return (
        <>
            ...
            <div style={{ marginLeft: '3%', marginRight: '3%', marginTop: '3%', paddingLeft: '3%', paddingRight: '3%', paddingBottom: '3%', paddingTop: '3%', borderRadius: '10px', backgroundColor: '#D9D9D9' }}>
                ...
                <Button variant="contained" endIcon={<AddIcon style={{ backgroundColor: 'black', borderRadius: '10px' }} />} sx={{ mt: '1%' }} onClick={() => navigate(`/createServices`)}>
                    Añadir Servicio
                </Button>
