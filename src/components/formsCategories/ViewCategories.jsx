...
const ViewCategories = () => {
    const [categories, setCViewCategories] = useState([]);
    const [page, setPage] = useState(0);
    const [rowsPerPage, setRowsPerPage] = useState(10);
    const navigate = useNavigate();  // Navegar entre rutas
    const [openDialog, setOpenDialog] = useState(false);
    const [categorieToDelete, setServiceToDelete] = useState(null);
    ...
    const columns = [
        ...
        { id: 'name', label: 'Nombre Categoria', minWidth: 150 },
    ...
    return (
        <>
            ...
            <div style={{ marginLeft: '3%', marginRight: '3%', marginTop: '3%', paddingLeft: '3%', paddingRight: '3%', paddingBottom: '3%', paddingTop: '3%', borderRadius: '10px', backgroundColor: '#D9D9D9' }}>
                <h1 id='labelhelp'>CRUD CATEGORIA</h1>
                <Button variant="contained" endIcon={<AddIcon style={{ backgroundColor: 'black', borderRadius: '10px' }} />} sx={{ mt: '1%' }} onClick={() => navigate(`/createCategories`)}>
                    Añadir Categoria
                </Button>
                                        ...
                                        <TableRow key={categorie.id}>
                                            <TableCell>
                                                <img
                                                    ...
                                                    alt={categorie.name_categorie}
                                                    className="categorie-thumbnail"
                                                    style={{ maxWidth: '100px', maxHeight: '100px' }}
                                                />
                                            </TableCell>
                                            <TableCell>{categorie.name}</TableCell>
                                            <TableCell>{categorie.description}</TableCell>
                                            <TableCell>{categorie.status}</TableCell>
                                            <TableCell align="right">
                                                <ButtonGroup sx={{ gap: 0.5 }} orientation="vertical">
                                                    <Button
                                                        ...
                                                        onClick={() => {
                                                            setServiceToDelete(categorie.id);
                                                            setOpenDialog(true);
                                                        }}
                                                    >
                                                        Delete
                                                    ...
                                                    >
                                                        ...
                                                        <DialogActions>
                                                            ...
                                                            <Button
                                                                onClick={() => {
                                                                    handleDelete(categorieToDelete);
                                                                    setOpenDialog(false);
                                                                }}
                                                                color="primary"
                                                                autoFocus
                                                    ...
                                                    <Button
                                                        ...
                                                        onClick={() => navigate(`/categories/edit/${categorie.id}`)}
                                                    >
                                                        Edit
                                                    </Button>
                                                </ButtonGroup>
